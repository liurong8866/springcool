...
) ENGINE=InnoDB AUTO_INCREMENT=44 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin COMMENT='config_info';
...
CREATE TABLE `his_config_info` (
  ...
  KEY `idx_did` (`data_id`)
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin COMMENT='多租户改造';
...
INSERT INTO `his_config_info` VALUES (2, 31, 'application-secret-dev.yml', 'DEFAULT_GROUP', '', 'secret:\n  #redis参数信息\n  redis:\n    host: 192.168.0.130\n    port: 6379\n    password:\n  #服务状态监控参数信息\n  security:\n    name: cool\n    password: cool123\n    title: 服务状态监控\n  # swagger参数信息\n  swagger:\n    title: 接口文档\n    license: Powered By cool\n    licenseUrl: https://doc.cooltt.cn\n    basePackage: com.springcool\n  # datasource主库参数信息\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://cool-mysql:3306/cool?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8\n    username: root\n    password: 123456\n  # druid控制台参数信息\n  druid:\n    stat-view-servlet:\n      enabled: true\n      loginUsername: admin\n      loginPassword: 123456\n  # nacos参数信息\n  nacos:\n    serverAddr: cool-nacos:8848', '7e0b1618670e07a1d33672f993505581', '2022-05-25 20:32:04', '2022-06-02 21:12:31', 'nacos', '0:0:0:0:0:0:0:1', 'U', '', '');
INSERT INTO `his_config_info` VALUES (7, 32, 'cool-tenant-dev.yml', 'DEFAULT_GROUP', '', 'springcool:\n  # 租户配置\n  tenant:\n    # 公共表配置\n    common-table:\n      - sys_menu\n      - sys_module\n    # 非租户表配置\n    exclude-table:\n      - te_tenant\n      - te_strategy\n      - te_source\n\n# mybatis-plus配置\nmybatis-plus:\n  # 搜索指定包别名\n  typeAliasesPackage: com.springcool.tenant\n  # 配置mapper的扫描，找到所有的mapper.xml映射文件\n  mapperLocations: classpath:mapper/**/*.xml\n\n# swagger配置\nswagger:\n  title: 租户模块${secret.swagger.title}\n  license: ${secret.swagger.license}\n  licenseUrl: ${secret.swagger.licenseUrl}\n\n#seata配置\nseata:\n  # 服务配置项\n  service:\n    # 虚拟组和分组的映射\n    vgroup-mapping:\n      cool-tenant-group: default\n', '92c5115c882739ff47cb110946dd32a4', '2022-05-25 20:34:49', '2022-06-02 21:15:04', 'nacos', '0:0:0:0:0:0:0:1', 'U', '', '');
INSERT INTO `his_config_info` VALUES (8, 33, 'cool-system-dev.yml', 'DEFAULT_GROUP', '', 'springcool:\n  # 租户配置\n  tenant:\n    # 公共表配置\n    common-table:\n      - sys_menu\n      - sys_module\n    # 非租户表配置\n    exclude-table:\n      - te_tenant\n      - te_strategy\n      - sys_dict_type\n      - sys_dict_data\n      - sys_config\n\n# mybatis-plus配置\nmybatis-plus:\n  # 搜索指定包别名\n  typeAliasesPackage: com.springcool.system\n  # 配置mapper的扫描，找到所有的mapper.xml映射文件\n  mapperLocations: classpath:mapper/**/*.xml\n\n# swagger配置\nswagger:\n  title: 系统模块${secret.swagger.title}\n  license: ${secret.swagger.license}\n  licenseUrl: ${secret.swagger.licenseUrl}\n  basePackage: ${secret.swagger.basePackage}\n  basePath:\n    - system.authority.controller\n\n#seata配置\nseata:\n  # 服务配置项\n  service:\n    # 虚拟组和分组的映射\n    vgroup-mapping:\n      cool-system-group: default', 'e26775ad66da4162453276fff4c603c2', '2022-05-25 20:35:19', '2022-06-02 21:15:31', 'nacos', '0:0:0:0:0:0:0:1', 'U', '', '');
INSERT INTO `his_config_info` VALUES (9, 34, 'cool-gen-dev.yml', 'DEFAULT_GROUP', '', 'springcool:\n  # 租户配置\n  tenant:\n    # 非租户表配置\n    exclude-table:\n      - gen_table\n      - gen_table_column\n\n# mybatis-plus配置\nmybatis-plus:\n  # 搜索指定包别名\n  typeAliasesPackage: com.springcool.gen\n  # 配置mapper的扫描，找到所有的mapper.xml映射文件\n  mapperLocations: classpath:mapper/**/*.xml\n  configuration:\n    jdbc-type-for-null: \'null\'\n\n# swagger配置\nswagger:\n  title: 代码生成${secret.swagger.title}\n  license: ${secret.swagger.license}\n  licenseUrl: ${secret.swagger.licenseUrl}\n\n# 代码生成\ngen: \n  # 作者\n  author: cool\n  # ui路径（空代表生成在后端主路径下，可设置为ui项目地址如：C:UserscoolMultiSaas-UI）\n  uiPath: \n  # 自动去除表前缀，默认是true\n  autoRemovePre: true\n  # 数据库映射\n  data-base:\n    # 字符串类型\n    type-str: [\"char\", \"varchar\", \"nvarchar\", \"varchar2\"]\n    # 文本类型\n    type-text: [\"tinytext\", \"text\", \"mediumtext\", \"longtext\"]\n    # 日期类型\n    type-date: [\"datetime\", \"time\", \"date\", \"timestamp\"]\n    # 时间类型\n    type-time: [\"datetime\", \"time\", \"date\", \"timestamp\"]\n    # 数字类型\n    type-number: [\"tinyint\", \"smallint\", \"mediumint\", \"int\", \"number\", \"integer\"]\n    # 长数字类型\n    type-long: [\"bigint\"]\n    # 浮点类型\n    type-float: [\"float\", \"double\", \"decimal\"]\n  # 字段配置\n  operate:\n    # 隐藏详情显示\n    not-view: [\"id\", \"createBy\", \"createTime\", \"updateBy\", \"updateTime\"]\n    # 隐藏新增显示\n    not-insert: [\"id\", \"createBy\", \"createTime\", \"updateBy\", \"updateTime\"]\n    # 隐藏编辑显示\n    not-edit: [\"id\", \"createBy\", \"createTime\", \"updateBy\", \"updateTime\"]\n    # 隐藏列表显示\n    not-list: [\"id\", \"createBy\", \"createTime\", \"updateBy\", \"updateTime\", \"remark\"]\n    # 隐藏查询显示\n    not-query: [\"id\", \"sort\", \"createBy\", \"createTime\", \"updateBy\", \"updateTime\", \"remark\"]\n    # 隐藏导入显示\n    not-import: [\"id\", \"createBy\", \"createTime\", \"updateBy\", \"updateTime\"]\n    # 隐藏导出显示\n    not-export: [\"id\", \"sort\", \"createBy\", \"updateBy\"]\n  # 基类配置\n  entity:\n    # 必定隐藏字段（前后端均隐藏）\n    must-hide: [\"delFlag\", \"tenantId\", \"ancestors\"]\n    # 后端基类\n    back:\n      base: [\"id\", \"name\", \"status\", \"sort\", \"remark\", \"createBy\", \"createTime\", \"updateBy\", \"updateTime\", \"delFlag\"]\n      tree: [\"parentId\", \"ancestors\"]\n      sub: []\n      tenant: [\"tenantId\"]\n    # 前端基类\n    front:\n      base: [\"createBy\", \"createName\", \"createTime\", \"updateBy\", \"updateName\", \"updateTime\", \"delFlag\"]\n      tree: [\"parentId\", \"ancestors\"]\n      sub: []\n      tenant: [\"tenantId\"]\n  # 表前缀（与remove-lists对应）\n  dict-type-remove: [\"sys_\", \"te_\", \"gen_\"]\n  # 表更替配置\n  remove-lists:\n      # 表前缀（生成类名不会包含表前缀）\n    - prefix: sys_\n      # 默认生成包路径 system 需改成自己的模块名称 如 system monitor tool\n      packageName: com.cool.system\n      frontPackageName: system\n    - prefix: te_\n      packageName: com.cool.tenant\n      frontPackageName: tenant\n    - prefix: gen_\n      packageName: com.cool.gen\n      frontPackageName: gen\n', '329e88a8de7fb74e8e6e66c4c55bbe67', '2022-05-25 20:37:19', '2022-06-02 21:17:23', 'nacos', '0:0:0:0:0:0:0:1', 'U', '', '');
INSERT INTO `his_config_info` VALUES (10, 35, 'cool-job-dev.yml', 'DEFAULT_GROUP', '', '# mybatis-plus配置\nmybatis-plus:\n  # 搜索指定包别名\n  typeAliasesPackage: com.springcool.job\n  # 配置mapper的扫描，找到所有的mapper.xml映射文件\n  mapperLocations: classpath:mapper/**/*.xml\n\n# swagger配置\nswagger:\n  title: 定时任务${secret.swagger.title}\n  license: ${secret.swagger.license}\n  licenseUrl: ${secret.swagger.licenseUrl}\n\n# seata配置\nseata:\n  # 服务配置项\n  service:\n    # 虚拟组和分组的映射\n    vgroup-mapping:\n      cool-job-group: default\n', '70e79c9aa279bb7a47ac4ec3edd0689f', '2022-05-25 20:37:49', '2022-06-02 21:17:50', 'nacos', '0:0:0:0:0:0:0:1', 'U', '', '');
INSERT INTO `his_config_info` VALUES (2, 36, 'application-secret-dev.yml', 'DEFAULT_GROUP', '', 'secret:\n  #redis参数信息\n  redis:\n    host: 192.168.0.130\n    port: 6379\n    password:\n  #服务状态监控参数信息\n  security:\n    name: admin\n    password: 123456\n    title: 服务状态监控\n  # swagger参数信息\n  swagger:\n    title: 接口文档\n    license: Powered By SpringCool\n    licenseUrl: https://doc.springcool.cn\n    basePackage: com.springcool\n  # datasource主库参数信息\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://cool-mysql:3306/cool?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8\n    username: root\n    password: 123456\n  # druid控制台参数信息\n  druid:\n    stat-view-servlet:\n      enabled: true\n      loginUsername: admin\n      loginPassword: 123456\n  # nacos参数信息\n  nacos:\n    serverAddr: cool-nacos:8848', 'e7fd45260de83ba2a77164d491077385', '2022-05-25 20:56:32', '2022-06-02 21:35:06', 'nacos', '0:0:0:0:0:0:0:1', 'U', '', '');
COMMIT;
