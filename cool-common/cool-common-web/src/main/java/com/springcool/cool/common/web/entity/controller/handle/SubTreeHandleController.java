package com.springcool.cool.common.web.entity.controller.handle;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import com.springcool.cool.common.web.entity.controller.SubTreeController;
...
import com.springcool.cool.common.web.entity.service.ISubTreeService;
...
public abstract class SubTreeHandleController<Q extends SubTreeEntity<D, SD>, D extends SubTreeEntity<D, SD>, IDS extends ISubTreeService<Q, D, SQ, SD>, SQ extends BaseEntity, SD extends BaseEntity, ISS extends IBaseService<SQ, SD>> extends TreeController<Q, D, IDS> {
     ...
     *
     * @param d 待修改数据对象
     * @see SubTreeController#editStatus(D)
     */
     ...
     * @see SubTreeController#batchRemove(List)
     */
