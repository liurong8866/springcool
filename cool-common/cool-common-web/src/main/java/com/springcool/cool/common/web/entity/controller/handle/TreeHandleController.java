...
import com.springcool.cool.common.web.entity.service.ITreeService;
...
public abstract class TreeHandleController<Q extends TreeEntity<D>, D extends TreeEntity<D>, IDS extends ITreeService<Q, D>> extends BaseController<Q, D, IDS> {
     ...
     * @see TreeController#listExNodes(TreeEntity)
     */
     ...
     *
     * @param d 待修改数据对象
     * @see TreeController#edit(D)
     * @see TreeController#editForce(D)
     */
     ...
     * @see TreeController#batchRemove(List)
     */
