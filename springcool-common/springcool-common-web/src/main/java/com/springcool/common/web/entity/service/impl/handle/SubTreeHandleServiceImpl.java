package com.springcool.common.web.entity.service.impl.handle;

import cn.hutool.core.util.ObjectUtil;
import com.springcool.common.web.entity.service.impl.SubTreeServiceImpl;
...
import com.springcool.common.web.entity.manager.ISubTreeManager;
import com.springcool.common.web.entity.service.IBaseService;
import com.springcool.common.web.entity.service.impl.TreeServiceImpl;
...
public abstract class SubTreeHandleServiceImpl<Q extends SubTreeEntity<D, SD>, D extends SubTreeEntity<D, SD>, IDG extends ISubTreeManager<Q, D, SQ, SD>, SQ extends BaseEntity, SD extends BaseEntity, ISS extends IBaseService<SQ, SD>> extends TreeServiceImpl<Q, D, IDG> {
     ...
     * @param id     Id
     * @param status 状态
     * @see SubTreeServiceImpl#update(SubTreeEntity)
     * @see SubTreeServiceImpl#updateStatus(Serializable, String)
     */
